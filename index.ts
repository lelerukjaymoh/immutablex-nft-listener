...
const main = async () => {
    try {
        ...
        await escrowContract.on("*", async (log: any) => {
            console.log("log ", log);
            ...
            if (eventName == "ProposalAccepted") {
                ...
                await escrowContract.swap(proposalId, {
                ...
                console.log("proposerNFT ", proposerNFTContractAddress, proposerNFTTokenId);
                console.log("proposeeNFT ", proposeeNFTContractAddress, proposeeNFTTokenId);
